        ...
        isRunning = true;
            if(Enable == 1) {
                if (mSensorManager.getSensorList(Sensor.TYPE_LINEAR_ACCELERATION).size() != 0)
                {
                	...
                	Toast.makeText(getBaseContext(), "Linear Accelerometer Sensor detected",Toast.LENGTH_LONG).show();
                }
                else{
                	Toast.makeText(getBaseContext(), "No Linear Accelerometer Sensor detected!",Toast.LENGTH_LONG).show();
                }
