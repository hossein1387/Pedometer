...
//=======================================================================================================================================
    ...
    private boolean authentication = false,NetworkAvalability=false,DoneUploading=true,mIsBound,SyncData=true;;
     ...
     TextView step, goal_text,battery_volt,battery_temp,est_time,charge_level;
...
//=======================================================================================================================================
	    private void UpdateFile(float[] data){
	    	...
	    	if ((samplecounter>NumberOfSamples)&&DoneUploading)
	    	{
		     ...
		     try {
		    	 	FileUtils.writeStringToFile(DataFile,"Sample."+counter+"    "+
		    	 			java.text.DateFormat.getDateTimeInstance().format(Calendar.getInstance().getTime())+
							"  "+"X:"+data[0]+"  "+"Y:"+data[1]+"  "+"Z:"+data[2]+"  "+"Number of Steps:"+stepCounter+"\r\n",true);
				} catch (IOException e) {
					e.printStackTrace();
				}	        		 
	    }
...
//=======================================================================================================================================
public int getPercent(double inVolt){
	int percent=0;
	 double[] voltage={
			2.5,2.572,2.624,2.685,2.755,2.81 ,2.85 ,2.87 ,2.937,2.998,3.054,3.104,
			3.158,3.192,3.234,3.265,3.269,3.319,3.343,3.363,3.374,3.388,3.395,3.405,
			3.414,3.418,3.425,3.431,3.434,3.44 ,3.446,3.45,3.456,3.46,3.465,3.474,
			3.48 ,3.486,3.493,3.5,3.505,3.512,3.515,3.524,3.529,3.53 ,3.,3.875 ,3.88,
			3.885,3.89,3.895,3.9,3.91,3.92,3.93,3.943,3.953,3.958,3.96,3.962,3.964,
			3.966,3.968,3.97,3.972,3.974,3.976,3.978,3.98,3.982,3.984,3.986,3.988,3.99,
			3.992,3.994,3.996,3.998,4,4.01,4.02,4.03,4.04,4.05,4.06,4.07,4.08,
			4.09,4.1,4.11,4.12,4.13,4.14,4.15,4.16,4.17,4.18,4.19,4.2};
		for (int i=0;i<100;i++){
			if(inVolt<voltage[i]){
				break;
			}else{
